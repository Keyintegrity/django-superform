...
class SuperFormMixin(object):
    ...
    .. code:: python
        ...
        class MySuperForm(SuperFormMixin, MyCustomForm, metaclass=SuperFormMetaclass):
            pass
...
class SuperModelFormMixin(SuperFormMixin):
    ...
    .. code:: python
        ...
        class MySuperForm(SuperModelFormMixin, MyCustomModelForm, metaclass=SuperModelFormMetaclass):
            pass
    """
...
class SuperModelForm(SuperModelFormMixin, forms.ModelForm, metaclass=SuperModelFormMetaclass):
    """
